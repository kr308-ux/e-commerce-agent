...
CREATOR_EMAIL_SEND_INTERVAL_SECONDS = float(
    os.getenv("CREATOR_EMAIL_SEND_INTERVAL_SECONDS", "30")
)
CREATOR_EMAIL_MAX_ATTEMPTS = int(
    os.getenv("CREATOR_EMAIL_MAX_ATTEMPTS", "3")
)
